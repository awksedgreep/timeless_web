defmodule TimelessWeb.UserAuthTest do
  use TimelessWeb.ConnCase

  alias TimelessWeb.Accounts
  alias TimelessWeb.Accounts.Scope
  alias TimelessWeb.UserAuth
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, TimelessWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
