defmodule TimelessWeb.Release do
  @moduledoc """
  ...
  defp seed_posts do
    ...
    Enum.each(posts, fn attrs ->
      TimelessWeb.Repo.insert!(
        Post.changeset(
          TimelessWeb.Repo.get_by(Post, slug: attrs.slug) || %Post{},
          attrs
        ),
  ...
  defp seed_projects do
    ...
    Enum.each(projects, fn attrs ->
      TimelessWeb.Repo.insert!(
        Project.changeset(
          TimelessWeb.Repo.get_by(Project, slug: attrs.slug) || %Project{},
          attrs
        ),
        on_conflict: {:replace_all_except, [:id, :inserted_at]},
        conflict_target: :slug
